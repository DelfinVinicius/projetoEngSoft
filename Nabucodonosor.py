...
while True:
    ...
    # Aqui é a do cadastro
        ...
        senha_cadastro = int(input('Crie uma senha com oito dígitos: '))
        ...
        while len(celular_cadastro) < 11 or len(celular_cadastro) > 11 or celular_cadastro not in "1234567890":
